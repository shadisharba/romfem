classdef temporal_mesh < handle
    ...
    methods
        ...
        function temporal = temporal_mesh(user_temporal_mesh)
            ...
            temporal.integration_coefficient = sparse(1, temporal.dof);
            ...
            for dof = 1:temporal.dof - 1
                temporal.integration_coefficient(1, dof:dof+1) = temporal.integration_coefficient(1, dof:dof+1) + dt(dof) * shape_function; % force integrator
