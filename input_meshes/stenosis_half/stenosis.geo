 /*
	...
	*/
	...
	Extrude {0,0,Z} {
	  Surface{14,12,16}; Layers{2}; Recombine;
	}
	Coherence;
 
	Physical Surface("ysym") = {51, 37, 73};
	Physical Surface("zsidesurfaces") = {60, 38, 82, 16, 14, 12};
	Physical Surface("yload") = {59, 29, 81};
	Physical Surface("xload1") = {47};
	Physical Surface("xload2") = {77};
	Physical Volume("stenosis") = {2, 1, 3};
