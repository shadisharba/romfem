function [numerical_model_obj, global_fields] = initialise_solver(solver_parameters, user_mesh, user_material, user_boundary_conditions, user_load, cycles_to_save, build_mode, previous_cycle)

solver_parameters.output_path = [solver_parameters.output_path, '_', datestr(now, 'yyyymmdd_HHMMSSFFF')];

if build_mode.build_mode_debug && cycles_to_save
...
numerical_model_obj.build_mode = build_mode;
