...
% use NN only with
% [equivalent_apparent_stress, deviatoric_apparent_stress, equivalent_stress] = compute_equivalent_stress(stress, back_stress, repelem(old_internal_damage, stress_componenets, 1));
% [f_vp, row, col, row6] = evaluate_yield_function(equivalent_apparent_stress, isotropic_hardening, material.user_material.sigma_y);
